...
{
	NSString *fileName = [_name stringByAppendingPathExtension:@"text"];
	NSString *tablePath = [[url path] stringByAppendingPathComponent:fileName];
	NSURL *tableURL = [NSURL fileURLWithPath:tablePath];
    ...
    NSString *tmpString = [self textRepresentationWithEncoding:encoding error:error entryWriteCallback:entryWriteCallback];
